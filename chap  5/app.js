...
let customerOrder = "5 Jackets";
let storeName = "Insharah's Store";
//document.write(`${customerName} Ordered ${customerOrder} on ${storeName}`)
...
let total = 100
let totalMarks = 300
let sub1Marks = +prompt("Enter your first subject Marks")
let sub2Marks = +prompt("Enter your seconed subject Marks")
let sub3Marks = +prompt("Enter your third subject Marks")
let obtainedMarks = sub1Marks+sub2Marks+sub3Marks

let percentage1 = sub1Marks/100*100
let percentage2 = sub1Marks/100*100
let percentage3 = sub1Marks/100*100
let totalPercentage = obtainedMarks/totalMarks*100
document.write(`<table><tr><th>Subject</th></tr>`)
document.write(`<tr><th>Total Marks</th></tr>`)
document.write(`<table><tr><th>Obtained Marks</th></tr>`)
document.write(`<table><tr><th>Percentage</th></tr>`)
